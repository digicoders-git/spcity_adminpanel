          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                {notifOpen && (
                  <div className="fixed sm:absolute left-4 right-4 sm:left-auto sm:right-0 top-16 sm:top-auto sm:mt-2 sm:w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
